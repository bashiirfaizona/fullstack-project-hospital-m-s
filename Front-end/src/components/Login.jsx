    ...
    <section className="bg-gray-50 min-h-screen flex items-center justify-center p-4 pt-24">
      <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-8">
        ...
        <form className="space-y-6">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-600 focus:border-emerald-600"
                required
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-slate-800 hover:bg-emerald-600 text-white py-3 px-4 rounded-lg font-medium transition-colors shadow-md hover:shadow-lg"
          >
            Sign In
          </button>
        </form>
