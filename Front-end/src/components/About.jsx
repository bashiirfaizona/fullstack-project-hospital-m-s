...
const About = () => {
  return (
    <div className="min-h-screen bg-white pt-0"> {/* Removed top padding */}
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-10 flex flex-col lg:flex-row items-center gap-8"> {/* Reduced padding and gap */}
        {/* Left Content */}
        <div className="lg:w-1/2 space-y-6"> {/* Reduced space-y-8 to space-y-6 */}
          ...
          {/* Mission, Vision, Values Cards - Smaller */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"> {/* Reduced gap */}
            {/* Mission Card */}
            <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100 hover:shadow-md transition-shadow"> {/* Reduced size and padding */}
              <div className="bg-emerald-100 p-2 rounded-full w-10 h-10 flex items-center justify-center mb-3"> {/* Smaller icon container */}
                <FaBullseye className="text-emerald-600 text-lg" /> {/* Smaller icon */}
              </div>
              <h3 className="font-semibold text-gray-800 mb-1.5">Our Mission</h3> {/* Smaller heading */}
        ...
        <div className="lg:w-1/2">
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-5 -right-5 bg-white p-3 rounded-md shadow-sm hidden lg:block">
